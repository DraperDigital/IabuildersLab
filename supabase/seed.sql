...
INSERT INTO public.tags (id, name, slug) VALUES ('089604fd-1b2d-418c-8571-8eca853d33d2', 'AGY CLI', 'agy-cli') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.tags (id, name, slug) VALUES ('1821a505-0412-4de0-8e63-56e3cde2b147', 'CRO', 'cro') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.tags (id, name, slug) VALUES ('1fc26181-3aae-4df7-85aa-fa97380d496c', 'DRAPER', 'draper') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.tags (id, name, slug) VALUES ('298146bd-5511-4751-829c-cff52bb4ae72', 'FFMPEG', 'ffmpeg') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.tags (id, name, slug) VALUES ('8995bc2d-2b0b-4c15-8405-ce1989d60cc3', 'Landing Page', 'landing-page') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.tags (id, name, slug) VALUES ('dcc99b36-dd69-4254-8537-f31076075974', 'Next.js', 'next.js') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.tags (id, name, slug) VALUES ('966aa0cd-b6cb-4279-8ba3-a3b78b356024', 'Skills', 'skills') ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.tags (id, name, slug) VALUES ('1a9c0f2a-531d-416d-8537-70c17cfc4ec8', 'SOP', 'sop') ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.tags (id, name, slug) VALUES ('db8822a8-7800-4daf-890b-c338fb885764', 'Spam', 'spam') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.tags (id, name, slug) VALUES ('e4fc4af5-bf3b-45cf-8c2b-c574dac4e320', 'Supabase', 'supabase') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO public.content_items (id, type, title, slug, summary, body_markdown, category, system_type, process_state, level, featured_image_url, prompt_text, customization_guide, reference_image_guide, is_published, is_featured, paywall_level, created_at, updated_at) VALUES ('036d1ac4-56a2-4d55-8f32-0e8389a3f5a0', 'system', '/lp-performance-analyzer — Auditoría de Conversión en Landing Pages', 'skill-lp-performance-analyzer', 'Skill ejecutable para Claude Code y Antigravity AGY CLI. Inspecciona la estructura, hooks visuales y puntos de fricción en Landing Pages para incrementar el porcentaje de conversión.', '
...
```
', 'Skills & CLI', 'Claude / AGY Skill', 'Estudio', 'advanced', NULL, '---
name: lp-performance-analyzer
description: Analiza la estructura de una Landing Page, identifica puntos de fuga de conversión y genera recomendaciones de reordenación de bloques basados en datos de comportamiento.
---
...
- Calificación global de conversión (0/100).
- Los 3 mayores puntos de fuga de ventas detectados.
- Código listo para copiar/reordenar en tu proyecto.', NULL, NULL, TRUE, TRUE, 'access', '2026-08-30T00:05:36.414Z', '2026-08-30T00:05:36.414Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('036d1ac4-56a2-4d55-8f32-0e8389a3f5a0', 'a8560299-366c-48c0-890e-7d75ce7ea470') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('036d1ac4-56a2-4d55-8f32-0e8389a3f5a0', '089604fd-1b2d-418c-8571-8eca853d33d2') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('036d1ac4-56a2-4d55-8f32-0e8389a3f5a0', '966aa0cd-b6cb-4279-8ba3-a3b78b356024') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('036d1ac4-56a2-4d55-8f32-0e8389a3f5a0', '1821a505-0412-4de0-8e63-56e3cde2b147') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('036d1ac4-56a2-4d55-8f32-0e8389a3f5a0', '8995bc2d-2b0b-4c15-8405-ce1989d60cc3') ON CONFLICT DO NOTHING;
INSERT INTO public.content_items (id, type, title, slug, summary, body_markdown, category, system_type, process_state, level, featured_image_url, prompt_text, customization_guide, reference_image_guide, is_published, is_featured, paywall_level, created_at, updated_at) VALUES ('1435a12f-1a65-42d2-87f5-29b7e641bd1e', 'system', '/email-deliverability-toolkit — Diagnóstico de Salud de Dominio & Spam', 'skill-email-deliverability-toolkit', 'Skill de terminal para auditar configuraciones DNS (SPF, DKIM, DMARC), analizar palabras gatillo de spam en copys fríos y garantizar la entrada a la bandeja de entrada primaria.', '
...
```
', 'Skills & CLI', 'Claude / AGY Skill', 'Estudio', 'intermediate', NULL, '---
name: email-deliverability-toolkit
description: Inspecciona textos de correo electrónico y registros DNS para evitar caer en la carpeta de spam en campañas de prospectación fría B2B.
---
...
2. Escanea palabras gatillo de spam (spam trigger words como "gratis", "ganar dinero", "garantizado").
3. Verifica la proporción de enlaces vs texto.
4. Genera una versión limpia de alta entregabilidad óptima para Gmail y Outlook Enterprise.', NULL, NULL, TRUE, TRUE, 'access', '2026-08-30T00:05:36.414Z', '2026-08-30T00:05:36.414Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('1435a12f-1a65-42d2-87f5-29b7e641bd1e', 'a8560299-366c-48c0-890e-7d75ce7ea470') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('1435a12f-1a65-42d2-87f5-29b7e641bd1e', '089604fd-1b2d-418c-8571-8eca853d33d2') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('1435a12f-1a65-42d2-87f5-29b7e641bd1e', '966aa0cd-b6cb-4279-8ba3-a3b78b356024') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('1435a12f-1a65-42d2-87f5-29b7e641bd1e', '36b17a19-bbe7-485e-8d21-d84900ca77a2') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('1435a12f-1a65-42d2-87f5-29b7e641bd1e', 'db8822a8-7800-4daf-890b-c338fb885764') ON CONFLICT DO NOTHING;
INSERT INTO public.content_items (id, type, title, slug, summary, body_markdown, category, system_type, process_state, level, featured_image_url, prompt_text, customization_guide, reference_image_guide, is_published, is_featured, paywall_level, created_at, updated_at) VALUES ('71d01c9e-8ed6-4cda-8143-1bcfe29fddfb', 'system', '/code-architecture-auditor — Auditoría de Código Next.js & Supabase', 'skill-code-architecture-auditor', 'Skill avanzada de ingeniería de software. Escanea repositorios Next.js App Router y Supabase para detectar fugas de seguridad en RLS, fallos de tipado TypeScript e ineficiencias de rendimiento.', '
...
2. Verifica que todas las funciones exportadas de archivos con ''use server'' sean `async`.
3. Comprueba que las tablas de Supabase tengan Row Level Security (RLS) habilitado.
4. Genera el informe de parches críticos y los comandos de corrección para la terminal.', NULL, NULL, TRUE, FALSE, 'access', '2026-08-30T00:05:36.414Z', '2026-08-30T00:05:36.414Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('71d01c9e-8ed6-4cda-8143-1bcfe29fddfb', 'a8560299-366c-48c0-890e-7d75ce7ea470') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('71d01c9e-8ed6-4cda-8143-1bcfe29fddfb', '089604fd-1b2d-418c-8571-8eca853d33d2') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('71d01c9e-8ed6-4cda-8143-1bcfe29fddfb', '966aa0cd-b6cb-4279-8ba3-a3b78b356024') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('71d01c9e-8ed6-4cda-8143-1bcfe29fddfb', 'dcc99b36-dd69-4254-8537-f31076075974') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('71d01c9e-8ed6-4cda-8143-1bcfe29fddfb', 'e4fc4af5-bf3b-45cf-8c2b-c574dac4e320') ON CONFLICT DO NOTHING;
INSERT INTO public.content_items (id, type, title, slug, summary, body_markdown, category, system_type, process_state, level, featured_image_url, prompt_text, customization_guide, reference_image_guide, is_published, is_featured, paywall_level, created_at, updated_at) VALUES ('72870c1a-e499-4122-8e2e-9c5434103426', 'system', '/copywriting-draper-engine — Generador de Copywriting D.R.A.P.E.R.', 'skill-copywriting-draper-engine', 'Skill de generación de textos comerciales de alta conversión directamente desde la línea de comandos bajo la metodología D.R.A.P.E.R.', '
...
1. Pasa la descripción cruda de tu producto o servicio.
2. Aplica la estructura D.R.A.P.E.R. (Diagnosticar, Rediseñar, Arquitectar, Programar, Encender, Refinar).
3. Devuelve 3 variaciones de titulares y el cuerpo del anuncio listo para campañas comerciales.', NULL, NULL, TRUE, FALSE, 'access', '2026-08-30T00:05:36.414Z', '2026-08-30T00:05:36.414Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('72870c1a-e499-4122-8e2e-9c5434103426', 'a8560299-366c-48c0-890e-7d75ce7ea470') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('72870c1a-e499-4122-8e2e-9c5434103426', '089604fd-1b2d-418c-8571-8eca853d33d2') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('72870c1a-e499-4122-8e2e-9c5434103426', '966aa0cd-b6cb-4279-8ba3-a3b78b356024') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('72870c1a-e499-4122-8e2e-9c5434103426', 'd870301f-5cd9-47a8-829d-e1099109185a') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('72870c1a-e499-4122-8e2e-9c5434103426', '1fc26181-3aae-4df7-85aa-fa97380d496c') ON CONFLICT DO NOTHING;
INSERT INTO public.content_items (id, type, title, slug, summary, body_markdown, category, system_type, process_state, level, featured_image_url, prompt_text, customization_guide, reference_image_guide, is_published, is_featured, paywall_level, created_at, updated_at) VALUES ('387216a7-5350-4dbe-81e0-427ac522b472', 'system', '/video-silence-trimmer — Recorte Automático de Silencios en Video', 'skill-video-silence-trimmer', 'Skill de automatización de edicion de video en terminal con FFMPEG. Detecta y elimina pausas y silencios en tomas en bruto para maximizar la retención.', '
...
```
', 'Skills & CLI', 'Claude / AGY Skill', 'Estudio', 'beginner', NULL, '---
name: video-silence-trimmer
description: Genera comandos FFMPEG para recortar silencios y pausas de archivos de video raw.
---
...
1. Proporciona la ruta del video en bruto.
2. La skill detecta niveles de audio por debajo de -30dB por más de 0.4s.
3. Genera y ejecuta la línea de comando FFMPEG para exportar la toma recortada lista para edición final.', NULL, NULL, TRUE, FALSE, 'access', '2026-08-30T00:05:36.414Z', '2026-08-30T00:05:36.414Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('387216a7-5350-4dbe-81e0-427ac522b472', 'a8560299-366c-48c0-890e-7d75ce7ea470') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('387216a7-5350-4dbe-81e0-427ac522b472', '089604fd-1b2d-418c-8571-8eca853d33d2') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('387216a7-5350-4dbe-81e0-427ac522b472', '966aa0cd-b6cb-4279-8ba3-a3b78b356024') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('387216a7-5350-4dbe-81e0-427ac522b472', 'e490492c-b837-4981-8514-6013481930ff') ON CONFLICT DO NOTHING;
INSERT INTO public.content_tags (content_id, tag_id) VALUES ('387216a7-5350-4dbe-81e0-427ac522b472', '298146bd-5511-4751-829c-cff52bb4ae72') ON CONFLICT DO NOTHING;
...
5. LLAMADA A LA ACCIÓN Y DISPARADORES DE URGENCIA ÉTICA
- Redacta la sección de cierre de la oferta con un resumen del valor total ($ Total Value vs $ Real Price).', NULL, NULL, TRUE, TRUE, 'access', '2026-08-30T00:05:36.399Z', '2026-08-30T00:05:36.399Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
3. REVELACIÓN DEL MECANISMO ÚNICO (Minuto 4 a 7): Explica por qué los métodos tradicionales fallan y por qué tu sistema es matemáticamente superior.
4. PRESENTACIÓN DEL PRODUCTO Y PRUEBA SOCIAL (Minuto 7 a 10): Muestra testimonios y desglose de módulos/beneficios.
5. LA LLAMADA A LA ACCIÓN FINAL (Minuto 10 a 12): Establece un ultimátum claro entre continuar igual o tomar acción hoy.', NULL, NULL, TRUE, TRUE, 'access', '2026-08-30T00:05:36.399Z', '2026-08-30T00:05:36.399Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
2. EMAIL 2 (El Caso de Estudio de 3 Oraciones): Muestra cómo ayudaste a un cliente similar a lograr [RESULTADO] en [TIEMPO].
3. EMAIL 3 (Aporte de Valor Gratuito): Entrega un recurso sin pedir nada a cambio (ej: "Grabé un video de 2 minutos analizando X").
4. EMAIL 4 (El Breakup Email): Cierre cordial avisando que no volverás a insistir si no es el momento adecuado.', NULL, NULL, TRUE, FALSE, 'access', '2026-08-30T00:05:36.399Z', '2026-08-30T00:05:36.399Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
- Primary Text (Texto principal de 3 párrafos).
- Headline (Titular corto y llamativo de menos de 5 palabras).
- Description (Línea de soporte debajo del titular).', NULL, NULL, TRUE, FALSE, 'access', '2026-08-30T00:05:36.399Z', '2026-08-30T00:05:36.399Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
4. MANEJO DE OBJECIONES EN VIVO:
   ...
   - Objeción de Dinero ("No puedo gastar ahora").
   - Objeción de Confianza ("¿Funcionará para mi nicho específico?").
5. LLAMADA A LA ACCIÓN CON URGENCIA ÉTICA: Temporizador de bonos para los primeros 10 compradores.', NULL, NULL, TRUE, FALSE, 'access', '2026-08-30T00:05:36.399Z', '2026-08-30T00:05:36.399Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
```
', 'Retratos & Branding', 'Flux 1.1', 'Editorial', 'advanced', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000&auto=format&fit=crop', 'Editorial magazine portrait of a confident tech founder in a sleek dark tailored suit, high-end studio lighting, soft Rembrandt side light, subtle purple backlighting, shot on 85mm f/1.4 lens, crisp details, natural skin texture, Forbes magazine cover style --ar 4:5 --v 6.1', NULL, NULL, TRUE, TRUE, 'access', '2026-08-30T00:05:36.399Z', '2026-08-30T00:05:36.399Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
```
', 'Minimalismo Tech', 'Flux 1.1', 'Estudio', 'beginner', 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?q=80&w=1000&auto=format&fit=crop', 'Minimalist studio macro photography of a matte black custom mechanical keyboard, subtle purple RGB backlight glowing between keycaps, dark slate desk surface, clean arrangement, shot on Sony A7IV 90mm macro lens --ar 4:5 --v 6.1', NULL, NULL, TRUE, FALSE, 'access', '2026-08-30T00:05:36.399Z', '2026-08-30T00:05:36.399Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye [SUBJECT] por el personaje o modelo que desees. Ajusta los [COLOR] para cambiar la atmósfera de los neones.', 'Usa una foto de retrato clara para que la doble exposición y los efectos de glitch se apliquen sobre tus rasgos.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia el color del sofá o los accesorios (oro/plata) para adaptar el prompt a tu estilo de marca.', 'Sube una foto sentada en una pose de poder para que la IA capture tu identidad en este entorno de lujo.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia el color del vestido o el tono de piel para personalizar tu avatar de vacaciones.', 'Una foto tuya sonriendo bajo luz natural funcionará mejor para integrarte en este escenario soleado.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Este prompt es ideal para emprendedoras. Ajusta el color del interior del coche (negro/marrón) para variar el mood.', 'Usa una foto tuya de perfil o tres cuartos para que las gafas de sol se ajusten correctamente a tu rostro.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye la descripción del hombre por la tuya. Este prompt es excelente para avatares artísticos únicos.', 'Sube tu foto de retrato (primer plano) para que la IA replique tus rasgos en el patrón de bordado.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia el destino a cualquier otra ciudad icónica manteniendo la iluminación de atardecer cinematográfico.', 'Sube una foto tuya de espaldas o de lado para que el ''body language'' se vea natural en la composición.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia ''blue light'' por ''magenta'' o ''electric green'' para un look aún más tecnológico.', 'Para este prompt es vital una pose en cuclillas o agachada para aprovechar la perspectiva del ángulo bajo.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia el traje de maid por un uniforme escolar o gótico para variar la temática manteniendo el fondo de neón.', 'Funciona mejor con fotos de rostro ''doll-like'' y expresiones suaves.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Este prompt es ideal para fotos con un toque nostálgico. Ajusta la cantidad de ''grain'' para un efecto más vintage.', 'Sube una foto con luz suave y expresión relajada para que la IA la funda con los colores pastel.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye ''Anne Hathaway'' por cualquier otra celebridad o descripción de avatar. Asegúrate de mantener la descripción de la pantalla del smartphone para conservar el efecto de perspectiva.', 'Usa una foto tuya de cuerpo completo en una pose divertida sobre un fondo neutro para facilitar la composición de la IA.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia los colores de la ropa o las flores para personalizar tu propia escena romántica. Este estilo es perfecto para tarjetas de felicitación.', 'No necesitas subir foto de referencia para este estilo, pero si lo haces, la IA intentará ''chibificar'' tus rasgos en los personajes.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Este prompt es ideal para crear invitaciones de boda o anuncios especiales con un toque mágico. Cambia la escena dentro del marco para adaptarlo a cualquier otro evento.', 'Si subes una foto tuya, la IA intentará poner un marco sobre ella y hacer que ''salgas'' de la foto.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Copia el prompt REAISEMP de este caso y añade el parámetro de referencia (comando --cref en MJ) para que la IA aplique el maquillaje de Catrina sobre tus propios rasgos.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Copia el prompt y verás cómo tu pose se transforma en este retrato minimalista de alta gama.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Asegúrate de que la referencia sea en alta resolución para que las texturas de piel sean tan naturales como en el ejemplo.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Aplica el prompt detallado y ajusta los parámetros de visualización para que el brillo metálico de tu producto resalte bajo el haz puntual de luz.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
# Ajuste de Color
* Para marcas más dinámicas, cambia el P_Post a "Colores vibrantes saturados" o "Gradiente azul corporativo".', 'Sube una foto tuya con una expresión de confianza. La IA mantendrá tu identidad mientras aplica la iluminación y el estilo editorial del traje negro.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Este sistema permite transformar cualquier objeto en vidrio. Cambia los "accent_colors" de ["blue", "green", "purple"] a tus colores de marca para una identidad visual única.', 'Adjunta la imagen del objeto que deseas retexturizar. El sistema Nano Banana respetará la forma original pero aplicará todas las propiedades físicas del vidrio holográfico.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye la descripción del personaje por la tuya. Puedes especificar "traje de samurái" o "ropa futurista" manteniendo el estilo de figura coleccionable.', 'Adjunta una foto de cuerpo completo de la persona que quieres convertir en figura. Asegúrate de que la ropa sea distintiva para que la IA la capture en el estilo anime.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia el entorno de "estantería de libros" por "tablero de coche" o "oficina moderna". También puedes ajustar el nivel de "caricaturización" del cuerpo.', 'Sube una selfie clara con buena iluminación. La IA detectará tus rasgos faciales para mantener la precisión en la cabeza del bobblehead mientras transforma el resto en una figura coleccionable.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye [animal type] por tus favoritos (ej: "golden retriever, tabby cat, and capybara"). Cambia [landmark] por cualquier lugar del mundo (ej: "Torre Eiffel", "Gran Muralla").', 'Este prompt no requiere imagen de referencia de rostro, pero puedes usar una foto de tu propia mascota para guiar el estilo de los animales usando pesos de imagen bajos.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.415Z', '2026-08-30T00:05:36.415Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Este estilo resalta las texturas. Si quieres un look más suave, cambia I_Iluminacion a "Luz suave de ventana".', 'Adjunta una foto con iluminación lateral. La IA potenciará el contraste y añadirá el grano cinematográfico manteniendo tu identidad.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Cambia los colores de neón en I_Iluminacion para adaptarlos a tu marca (ej: "Violeta y Cian"). Puedes cambiar el peinado en R_Render para un look más agresivo.', 'Usa una foto con iluminación fuerte desde un lado. La IA integrará los colores neón sobre tu rostro manteniendo la pose de giro al hombro.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sube tu foto de referencia para copiar exactamente el ángulo y la expresión.', 'La IA intentará replicar tu pose y entorno 1:1.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Ideal para perfiles con estética misteriosa o rebelde.', 'Usa una selfie directa. El efecto de flash aplanará la imagen, así que una foto con buena definición ayuda.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Este prompt está diseñado para mejorar fotos existentes dándoles un look de cine.', 'Sube la foto que quieras ''restaurar'' o mejorar. La IA respetará la composición original.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye el caballo por otro elemento simbólico si lo deseas, pero mantén la iluminación de alto contraste.', 'Una foto con gafas de sol y actitud seria encajará perfectamente.', TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.416Z', '2026-08-30T00:05:36.416Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, TRUE, 'pro', '2026-08-30T00:05:36.369Z', '2026-08-30T00:05:36.371Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, TRUE, 'pro', '2026-08-30T00:05:36.371Z', '2026-08-30T00:05:36.371Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, TRUE, 'pro', '2026-08-30T00:05:36.372Z', '2026-08-30T00:05:36.372Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, TRUE, 'pro', '2026-08-30T00:05:36.373Z', '2026-08-30T00:05:36.373Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, FALSE, 'free_preview', '2026-01-23T05:34:12.815Z', '2026-08-30T00:05:36.373Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, FALSE, 'free_preview', '2026-01-23T05:34:12.816Z', '2026-08-30T00:05:36.374Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.374Z', '2026-08-30T00:05:36.374Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.374Z', '2026-08-30T00:05:36.374Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.375Z', '2026-08-30T00:05:36.375Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
}', NULL, NULL, TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.376Z', '2026-08-30T00:05:36.376Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye la descripción del avatar o la marca de la gorra si prefieres usar otra prenda. Ajusta el color del envoltorio del coche cambiando `CHROME PINK / rose gold` por otro tono (ej. `CHROME EMERALD GREEN`).', 'Usa una foto donde tu sujeto esté mirando directamente a la cámara para mantener la mirada fija en el teléfono del selfie de manera coherente.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.376Z', '2026-08-30T00:05:36.376Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye la descripción física del avatar (cabello, ojos, tono de piel) por la tuya. Ajusta la prenda (ej. cambia ''Vestido sweater de punto grueso color crema'' por ''Polerón de lana negro'') para renovar el outfit.', 'Usa una foto donde tu rostro se vea de frente o ligeramente perfilado de modo que el flash retro resalte tu mirada.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.376Z', '2026-08-30T00:05:36.376Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Modifica el top de manga larga negro por otro color (ej. ''blanco'' o ''rojo oscuro'') para jugar con el contraste del flash. Puedes adaptar el fondo de la ventana para reflejar otra localización de fondo en la ciudad.', 'Usa una foto tomada con flash frontal directo a tu avatar, preferiblemente levantando los brazos para simular la pose de atarse el pelo de manera fluida.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.377Z', '2026-08-30T00:05:36.377Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Modifica la blusa wrap verde oliva por otra prenda y color de tu elección (ej. ''camisa de lino blanca''). Puedes sustituir el bolso negro con cadena dorada por otro accesorio como unas gafas de sol.', 'Usa una foto donde tu rostro tenga una sonrisa radiante y mire directamente a la cámara para asegurar una coherencia perfecta con la expresión alegre del prompt.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.377Z', '2026-08-30T00:05:36.377Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Sustituye la descripción del pelo y ropa por la tuya. Puedes alterar la funda de stickers y el diseño de la cama de fondo modificando la descripción en los campos correspondientes de entorno.', 'Usa una foto donde estés sentada en el suelo apoyándote hacia atrás de manera lateral para que el render conserve la inclinación corporal exacta.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.377Z', '2026-08-30T00:05:36.377Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Modifica el tipo de vestido o color del encaje de seda para renovar tu outfit. Puedes agregar o quitar elementos del mostrador del baño ajustando la descripción en los detalles del entorno.', 'Usa una foto donde aparezcas sentada sobre un mostrador o mesa inclinándote levemente al espejo de modo que la pose sea consistente.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.377Z', '2026-08-30T00:05:36.377Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Modifica el color del abrigo o bodysuit (ej. cambia ''Bodysuit blanco'' por ''Bodysuit negro satinado''). Puedes adaptar la composición reclinada en el sofá ajustando los parámetros de pose.', 'Usa una foto donde estés reclinada en un sofá para mantener la coherencia anatómica perfecta y la inclinación natural de la cabeza.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.377Z', '2026-08-30T00:05:36.377Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Modifica el color del gato (ej. cambia ''gato negro'' por ''gato siamés''). Puedes retirar el flequillo o el piercing de septum editando las especificaciones del avatar.', 'Usa una foto donde tu rostro y mejilla toquen el objeto o mascota de la toma original para mantener la coherencia espacial y de la mano sosteniendo el pelaje.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.377Z', '2026-08-30T00:05:36.377Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Modifica el color del bikini (ej. cambia ''bikini blanco'' por ''bikini negro o rojo''). Puedes alterar el tono de cabello a otro color manteniendo el acabado húmedo.', 'Usa una foto donde levantes un brazo por detrás de la cabeza y mantengas una expresión íntima para asegurar que la superposición anatómica sea totalmente fluida.', TRUE, TRUE, 'free_preview', '2026-08-30T00:05:36.377Z', '2026-08-30T00:05:36.377Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
...
Marcadores de posición para prueba social.
Sección de precios con un CTA claro y una sección de cierre que genere urgencia real.
[Inserta los datos de tu oferta, problema y objeciones aquí]', NULL, NULL, TRUE, FALSE, 'free_preview', '2026-08-30T00:05:36.389Z', '2026-08-30T00:05:36.389Z') ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, summary = EXCLUDED.summary, body_markdown = EXCLUDED.body_markdown, category = EXCLUDED.category, featured_image_url = EXCLUDED.featured_image_url, prompt_text = EXCLUDED.prompt_text;
